<template>
  <q-page class="bg-grey-3">
    <div class="row q-pa-md">
              ...
              <q-item class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input
                    ...
                    autogrow
                    dense
                    v-model="medicine_add.description"
                    label="Описание"
                  />
                </q-item-section>
              </q-item>
              ...
              <q-item class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input
                    ...
                    outlined
                    dense
                    v-model="medicine_add.purchase_price"
                    label="Цена покупки"
                  />
                </q-item-section>
              </q-item>
              <q-item class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input
                    ...
                    outlined
                    dense
                    v-model="medicine_add.selling_price"
                    label="Цена продажи"
                  />
                </q-item-section>
              </q-item>
              ...
              <q-item class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input
                    ...
                    color="blue"
                    outlined
                    v-model="medicine_add.expire_date"
                    label="Годен до"
                  >
                    <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
      ...
      <div
        class="col-lg-12 col-md-12 col-xs-12 col-sm-12 row justify-end q-mt-sm"
      >
        <q-btn
          class="text-capitalize bg-blue text-white"
          @click="addMedicine"
          size="md"
          :disable="medicine_add.quantity == '' && medicine_add.piece == ''"
          >Добавить</q-btn
        >
      </div>
...
export default {
  ...
  watch: {
    ...
    "medicine_add.title": function (newVal, oldVal) {
      if (newVal != "") {
        this.medicine_add = {
          ...
          barcode: this.response[0].barcode,
          country: this.response[0].country,
          manufacture: this.response[0].manufacture,
          serial_code: this.response[0].serial_code,
    ...
    "medicine_add.barcode": function (newVal, oldVal) {
      if (newVal != "") {
        this.medicine_add = {
          title: this.response.data.data[0].title,
          barcode: this.medicine_add.barcode,
          country: this.response.data.data[0].country,
          manufacture: this.response.data.data[0].manufacture,
          serial_code: this.response.data.data[0].serial_code,
          capacity: this.response.data.data[0].capacity,
        };
      }
    },
  },
