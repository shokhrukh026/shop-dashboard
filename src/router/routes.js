const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {path: '/return/:branch_id', name: 'return', component: () => import('pages/Return.vue'), props: true, meta: {authRequired: true}},
      ...
      {path: '/branch-info-detail/:branch_id/:business_product_id', name: 'branch-info-detail', component: () => import('pages/Branch-info-detail.vue'), props: true, meta: {authRequired: true}},
